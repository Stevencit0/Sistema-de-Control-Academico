...
export default function LoginDocente() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const res = await fetch("http://localhost:3001/login-docente", {
      method: "POST",
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-xl shadow max-w-sm w-full">
        ...
        <h2 className="text-center text-2xl font-bold mb-6">Docente</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button className="w-full bg-green-700 text-white py-2 rounded">Ingresar</button>
        </form>
